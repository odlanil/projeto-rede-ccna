# Documentação Bloco C

---

O Bloco C da empresa é um bloco administrativo e acomoda três subequipes representadas neste laboratório:
- Equipe de Marketing
- Equipe de Compras
- Equipe de Vendas
...
## Definição das VLANs
Equipe de Rede:
- VLAN 160 - 172.18.160.0/24

Equipe de Analistas:
- VLAN 170 - 172.18.170.0/24

Equipe de Call Center::
- VLAN 180 - 172.18.180.0/24
...
- Este laboratório representa a estrutura lógica da equipe de administrativa no Bloco C

---

## Camada de distribution
A camada de distribuição do bloco C acomoda um switche 3650 24PS GigabitEthernet (Layer 3) que proverá o roteamento entre VLANs e o roteamento externo.
