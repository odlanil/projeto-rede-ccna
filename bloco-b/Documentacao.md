...
O Bloco B da empresa é um bloco administrativo e acomoda três subequipes representadas neste laboratório:
...
## Definição das VLANs
Equipe de Rede:
- VLAN 130 - 172.17.130.0/24

Equipe de Analistas:
- VLAN 140 - 172.17.140.0/24

Equipe de Call Center::
- VLAN 150 - 172.17.150.0/24
...
- Este laboratório representa a estrutura lógica da equipe de administrativa no Bloco B

---

## Camada de distribuição
A camada de distribuição do bloco B acomoda um switche 3650 24PS GigabitEthernet (Layer 3) que proverá o roteamento entre VLANs e o roteamento externo.
